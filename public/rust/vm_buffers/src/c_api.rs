...
pub const __GLIBCXX__: u32 = 20200723;
...
pub const ByteOrder_LittleEndian: ByteOrder = 0;
pub const ByteOrder_BigEndian: ByteOrder = 1;
pub const ByteOrder_Native: ByteOrder = 2;
...
pub struct BytesWriter {
    ...
    pub buffer_cursor: size_t,
}
#[test]
fn bindgen_test_layout_BytesWriter() {
    assert_eq!(
        ::std::mem::size_of::<BytesWriter>(),
        32usize,
        concat!("Size of: ", stringify!(BytesWriter))
    );
    assert_eq!(
        ::std::mem::align_of::<BytesWriter>(),
        8usize,
        concat!("Alignment of ", stringify!(BytesWriter))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BytesWriter>())).byte_order as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(BytesWriter),
            "::",
            stringify!(byte_order)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BytesWriter>())).buffer as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(BytesWriter),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BytesWriter>())).buffer_size as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(BytesWriter),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BytesWriter>())).buffer_cursor as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(BytesWriter),
            "::",
            stringify!(buffer_cursor)
        )
    );
}
#[repr(C)]
...
#[test]
fn bindgen_test_layout_BytesReader() {
    assert_eq!(
        ::std::mem::size_of::<BytesReader>(),
        32usize,
        concat!("Size of: ", stringify!(BytesReader))
    );
    assert_eq!(
        ::std::mem::align_of::<BytesReader>(),
        8usize,
        concat!("Alignment of ", stringify!(BytesReader))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BytesReader>())).byte_order as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(BytesReader),
            "::",
            stringify!(byte_order)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BytesReader>())).buffer as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(BytesReader),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BytesReader>())).buffer_size as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(BytesReader),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<BytesReader>())).buffer_cursor as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(BytesReader),
...
extern "C" {
    pub fn vm_buffers_create_bytes_writer(
...
extern "C" {
    pub fn vm_buffers_bytes_writer_clear(writer: *mut BytesWriter);
}
extern "C" {
    pub fn vm_buffers_bytes_writer_write_int32_t(writer: *mut BytesWriter, value: i32);
}
extern "C" {
    pub fn vm_buffers_bytes_writer_write_int64_t(writer: *mut BytesWriter, value: i64);
}
extern "C" {
    pub fn vm_buffers_bytes_writer_write_float(writer: *mut BytesWriter, value: f32);
}
extern "C" {
    pub fn vm_buffers_bytes_writer_write_double(writer: *mut BytesWriter, value: f64);
}
extern "C" {
    pub fn vm_buffers_bytes_writer_write_byte(writer: *mut BytesWriter, byte: u8);
}
extern "C" {
    pub fn vm_buffers_bytes_writer_write_char(writer: *mut BytesWriter, ch: ::std::os::raw::c_char);
}
extern "C" {
...
extern "C" {
    pub fn vm_buffers_bytes_reader_reset(reader: *mut BytesReader);
}
extern "C" {
    pub fn vm_buffers_bytes_reader_read_int32_t(reader: *mut BytesReader) -> i32;
}
extern "C" {
...
extern "C" {
    pub fn vm_buffers_bytes_reader_read_double(reader: *mut BytesReader) -> f64;
}
extern "C" {
    pub fn vm_buffers_bytes_reader_read_byte(reader: *mut BytesReader) -> u8;
}
extern "C" {
